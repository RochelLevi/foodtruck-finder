...
# truck20 = Truck.create(name: , category_id: cat3.id, location_id: loc20.id, img_url: )
# truck21 = Truck.create(name: , category_id: cat3.id, location_id: loc20.id, img_url: )
# truck22 = Truck.create(name: , category_id: cat3.id, location_id: loc20.id, img_url: )
# truck23 = Truck.create(name: , category_id: cat3.id, location_id: loc20.id, img_url: )
# truck24 = Truck.create(name: , category_id: cat3.id, location_id: loc20.id, img_url: )
# truck25 = Truck.create(name: , category_id: cat3.id, location_id: loc20.id, img_url: )
# truck26 = Truck.create(name: , category_id: cat3.id, location_id: loc20.id, img_url: )
