...
review1(title: "Not Great" ,  rating: 2, truck_id: truck2.id , user_id: mike.id,content: "Overpriced, and underwhelming. Juices are ill conceived and watered down with cheaper ingredients like rice milk (and less veg)muffins (though 100 calories) are so bland and flavorless. I make 100 cal yummies too, mine just don't taste like cardboard.")
review2(title: "My Favorite" ,  rating: 5, truck_id: truck2.id , user_id: jazmin.id, content:"Choco-nana is amazing! This place has very quick service and always serves me with a smile. Will always return!")
review3(title: "Dangerously Good",  rating: 5, truck_id: truck3.id, user_id: rochel.id, content: "Wow. These are  bit pricey but they are worth every penny! These things are delicious and I have to try not to eat too many of them! I took a friend here and he is now hooked too.")
review4(title: "Love This Place",  rating: 5, truck_id: truck3.id, user_id: jazmin.id, content: "Very yummy and nice to look at. If you have a sweet tooth, these waffles are a must! I do not usually gravitate towards sweet foods, however, this was definitely very delicious and I would definitely go again")
review5(title: "Best Breakfast!",  rating: 5, truck_id: truck3.id, user_id: craig.id, content:"I was hurrying to work the other day and I didn't have a chance to eat my lunch. Some tempting and sweet smell was around the waffle cart, so I just couldn't pass it without trying! I ordered simple waffle with Nutella, nothing special, but it was suuuper delicious. For less then 10$ you can get full and have a wonderful mood, because your endorphins will dance salsa after this. P.S. Take a lot of napkins.")
# review6(title: ,  rating: , truck_id: , user_id: , content:)
# review7(title: ,  rating: , truck_id: , user_id: , content:)
# review8(title: ,  rating: , truck_id: , user_id: , content:)
# review9(title: ,  rating: , truck_id: , user_id: , content:)
# review10(title: ,  rating: , truck_id: , user_id: , content:)
